...
export default function Error({ reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <section aria-labelledby="portal-student-directory-error-heading" className="portal-counseling portal-student-directory portal-counseling--state" role="alert">
      <PortalPageHeader
        ...
        headingId="portal-student-directory-error-heading"
        title="Student directory"
      />
      <PortalCollectionFrame className="portal-counseling__frame portal-counseling__frame--state">
        <h2>We couldn’t load the Student Directory.</h2>
