...
export const PORTAL_CAPABILITIES = {
  ...
  counselingSessionsQueueView: "counseling_sessions.queue.view",
  studentRecordsViewScoped: "student_records.view_scoped",
  studentRecordsViewInstitution: "student_records.view_institution",
  ...
  institutionalIdentityManage: "institutional_identity.manage",
...
const PORTAL_SEARCH_ADDITIONS: readonly PortalSearchItem[] = [
  ...
  },
  {
    ...
    keywords: ["identity", "documents", "templates", "institution"],
